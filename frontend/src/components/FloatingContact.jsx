...
export default function FloatingContact() {
  ...
  const handleAction = (type) => {
    if (type === "whatsapp") {
      window.open("https://wa.me/919989241515", "_blank");
    } else if (type === "call") {
      window.location.href = "tel:08832474088";
    }
  };
      ...
      {isOpen ? (
        <div className="flex flex-col gap-3 animate-in fade-in slide-in-from-bottom-8 duration-300">
          ...
          <button 
            ...
            className="w-14 h-14 bg-[#4ade80] text-white rounded-full shadow-xl flex items-center justify-center hover:scale-110 transition-transform"
            title="WhatsApp"
          >
            <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24">
