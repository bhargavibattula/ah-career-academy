...
const tabContent = {
  "Professional Upskilling": {
    ...
    stats: [{ value: "50+", label: "Courses" }, { value: "3-6 Months", label: "Duration" }, { value: "92%", label: "Placement" }],
    included: ["Live Online Classes", "Industry Certifications", "Career Mentorship", "Salary Hike Guarantee"],
    story: "After completing the Data Science program, I got a 40% salary hike at my current company — Ravi",
    btnLabel: "Explore Professional Upskilling",
  },
  "Placement Bootcamps": {
    badge: "Placement Solutions",
    subtitle: "Placement Bootcamps",
    desc: "Intensive bootcamps focused on getting you job-ready with real interview preparation.",
    stats: [{ value: "20+", label: "Bootcamps" }, { value: "3-4 Months", label: "Duration" }, { value: "98%", label: "Placement" }],
    included: ["Mock Interviews", "Resume Building", "HR Preparation", "Company Tie-Ups"],
    story: "Cracked 3 interviews in one week after the bootcamp. The prep was incredible — Priya",
    btnLabel: "Explore Placement Bootcamps",
  },
  "Skill To Job": {
    ...
    stats: [{ value: "30+", label: "Courses" }, { value: "2-3 Months", label: "Duration" }, { value: "95%", label: "Placement" }],
    included: ["Gap Skill Analysis", "Targeted Training", "Job Placement", "Interview Support"],
    story: "Transitioned from a non-tech background to a Java developer role in 3 months — Suresh",
  ...
  "Corporate Training": {
    ...
    stats: [{ value: "40+", label: "Courses" }, { value: "2-4 Months", label: "Duration" }, { value: "95%", label: "Placement" }],
    included: ["Weekend Batches", "Flexible Timing", "Industry Certifications", "Salary Hike Guarantee"],
    story: "After just four months of training, I got placed as a Java Developer at Hiscope CyberLinks with a 6 LPA offer — Vinay",
    btnLabel: "Explore Professional Upskilling",
  },
};
