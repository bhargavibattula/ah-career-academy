export const courses = [
  {
    ...
    description: "Master the essential office tools enhanced with modern AI capabilities.",
    longDescription: "This course takes you beyond basic spreadsheet and document creation. You will learn how to leverage AI tools within the MS Office suite to automate tasks, generate insights, and boost productivity by 10x.",
    duration: "2 Months",
    fees: "Contact for Pricing",
    curriculum: [
      "Advanced Excel with AI Formulas",
      "PowerPoint Presentation Design with AI",
      "Word Automation with Macros and AI",
      "Outlook Productivity Hacks",
      "Integration with ChatGPT and AI Plugins"
    ],
    skills: ["Excel", "Word", "PowerPoint", "AI Tools", "Data Automation"]
  },
  {
    id: "python-fullstack",
    ...
    skills: ["Python", "Django", "SQL", "Data Structures", "Rest APIs"]
  },
  {
    ...
    skills: ["SEO", "SMM", "Google Ads", "Content Strategy", "Analytics"]
  },
  {
    id: "tally-gst",
  ...
  },
  {
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Basic Structure", "Forms & Tables", "Semantic HTML5", "Accessibility", "SEO Best Practices"],
    skills: ["HTML", "Web Structure", "SEO"]
  },
  {
    id: "css-crash",
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["CSS Selectors", "Flexbox & Grid", "Responsive Design", "Animations", "Tailwind/Bootstrap Intro"],
  ...
  },
  {
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Company Creation", "Ledgers & Groups", "Voucher Entries", "Inventory", "Basic GST"],
    skills: ["Tally Prime", "Accounting", "Data Entry"]
  },
  {
    id: "seo-crash",
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Keyword Research", "On-Page SEO", "Technical SEO", "Link Building", "Analytics"],
  ...
  },
  {
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Basic Queries", "Joins & Subqueries", "Aggregations", "Database Design", "Stored Procedures Intro"],
    skills: ["SQL", "Database Design", "Data Analytics"]
  },
  {
    id: "excel-crash",
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Formulas & Functions", "Data Analysis", "Pivot Tables", "Dashboards", "Macros Intro"],
  ...
  },
  {
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Tensors", "Neural Networks", "Computer Vision Basics", "Model Training", "Deployment"],
  ...
  },
  {
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Array Creation", "Indexing & Slicing", "Mathematical Operations", "Broadcasting", "Linear Algebra"],
    skills: ["NumPy", "Python", "Data Science"]
  },
  {
    id: "pandas-crash",
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Series & DataFrames", "Data Cleaning", "Merging & Joining", "Group By", "Time Series Analysis"],
  ...
  },
  {
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["Basic Plots", "Customization", "Subplots", "Advanced Visualizations", "Seaborn Intro"],
    skills: ["Matplotlib", "Data Visualization", "Python"]
  },
  {
    id: "pytorch-crash",
    ...
    duration: "45 Days",
    fees: "Contact for Pricing",
    curriculum: ["PyTorch Tensors", "Autograd", "Building Neural Networks", "Training Loops", "Transfer Learning"],
  ...
  },
  {
    ...
    fees: "Contact for Pricing",
    curriculum: [
      "Spring Boot Architecture & Setup",
      "Building RESTful Services",
      "Spring Data JPA & Database Integration",
      "Security with Spring Security",
      "Microservices Concepts & Deployment"
    ],
    skills: ["Java", "Spring Boot", "Microservices", "REST APIs", "JPA"]
  },
  {
    id: "data-science",
    ...
    duration: "6 Months",
    fees: "Contact for Pricing",
    curriculum: ["Python for Data Science", "Machine Learning", "Deep Learning", "NLP", "Computer Vision"],
  ...
  },
  {
    ...
    duration: "4 Months",
    fees: "Contact for Pricing",
    curriculum: ["HTML/CSS/JS", "React.js", "Node.js & Express", "MongoDB", "Full Stack Projects"],
  ...
  },
  {
    ...
    duration: "3 Months",
    fees: "Contact for Pricing",
    curriculum: ["CRM Basics", "Salesforce Admin", "Apex Programming", "Lightning Web Components", "Integration"],
    skills: ["Salesforce", "CRM", "Apex", "LWC"]
  },
  {
    ...
    duration: "1 Month",
    fees: "Contact for Pricing",
    curriculum: ["Modern Teaching Methods", "Technical Upskilling", "Industry Trends", "Research Methodologies", "Student Mentoring"],
    skills: ["Mentoring", "Teaching", "Leadership"]
  },
  {
    id: "microsoft-azure",
    ...
    duration: "3 Months",
    fees: "Contact for Pricing",
    curriculum: ["Azure Fundamentals", "Virtual Machines", "Azure App Services", "Azure SQL Database", "Azure Security"],
  ...
  },
  {
    ...
    duration: "3 Months",
    fees: "Contact for Pricing",
    curriculum: ["AWS Basics", "Compute Services (EC2)", "Storage (S3)", "Networking (VPC)", "Security & IAM"],
  ...
  },
  {
    ...
    duration: "3 Months",
    fees: "Contact for Pricing",
    curriculum: ["Network Security", "Footprinting & Recon", "System Hacking", "Web App Penetration", "Cryptography"],
    skills: ["Cyber Security", "Penetration Testing", "Networking"]
  },
  {
    id: "devops",
    ...
    duration: "4 Months",
    fees: "Contact for Pricing",
    curriculum: ["Version Control (Git)", "CI/CD (Jenkins)", "Containerization (Docker)", "Orchestration (Kubernetes)", "Infrastructure as Code"],
    skills: ["DevOps", "Docker", "Kubernetes", "Jenkins", "AWS"]
  },
  {
    id: "cyber-security",
    ...
    duration: "4 Months",
    fees: "Contact for Pricing",
    curriculum: ["Security Fundamentals", "Network Defense", "Risk Management", "Incidence Response", "Security Operations"],
    skills: ["Cyber Security", "Network Defense", "Risk Assessment"]
  },
  {
    id: "cloud-technology",
    ...
    duration: "2 Months",
    fees: "Contact for Pricing",
    curriculum: ["Cloud Concepts", "IaaS, PaaS, SaaS", "Cloud Architecture", "Migration Strategies", "Cloud Security Basics"],
    skills: ["Cloud Computing", "Architecture", "Networking"]
  }
];
