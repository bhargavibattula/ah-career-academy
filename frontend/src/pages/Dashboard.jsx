  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      <div className="flex-1 max-w-5xl mx-auto w-full px-4 py-10">
        ...
        {/* Welcome Banner */}
        <div className="bg-[#0F172A] rounded-2xl p-7 mb-8 text-white shadow-xl shadow-blue-950/25">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 bg-[#2563EB] rounded-2xl flex items-center justify-center text-2xl font-black shadow-lg shadow-blue-600/25">
              {user?.name?.[0]?.toUpperCase()}
            </div>
            <div>
              <h1 className="text-xl font-bold flex items-center gap-2">
                Welcome back, {user?.name}! 
                <HandRaisedIcon className="w-5 h-5 text-[#38BDF8]" />
              </h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          {[
            ...
            { label: "Certificates Earned", value: "0", icon: <TrophyIcon className="w-8 h-8" />, color: "bg-sky-50 border-sky-100 text-[#38BDF8]" },
        ...
        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm mb-8">
          <div className="px-6 py-4 border-b border-gray-100">
            <h2 className="font-bold text-[#0F172A] text-base">My Course Registrations</h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="py-12 text-center">
              ...
              <Link
                to="/"
                className="inline-block mt-4 bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-semibold px-6 py-2.5 rounded-lg text-sm transition-colors"
              >
                Explore Courses →
              </Link>
            </div>
                    ...
                    <tr key={reg._id} className="hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <span className={`text-xs font-bold px-3 py-1 rounded-full ${
                          reg.status === 'pending' ? 'bg-sky-100 text-[#2563EB]' :
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 text-center shadow-sm">
          <RocketLaunchIcon className="w-12 h-12 text-[#2563EB] mx-auto mb-4 opacity-80" />
          <h2 className="text-lg font-bold text-[#0F172A] mb-2 uppercase tracking-tight">Start Your Learning Journey</h2>
          ...
          <Link
            to="/"
            className="inline-block bg-[#2563EB] hover:bg-[#1D4ED8] text-white font-bold px-8 py-3.5 rounded-xl text-sm transition-all shadow-lg shadow-blue-600/25 active:scale-95"
          >
            Explore Courses
          </Link>
        </div>
